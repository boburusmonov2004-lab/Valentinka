...
const App: React.FC = () => {
  ...
  const [content, setContent] = useState({
    ...
    proposalTitle: 'Будете моей валентинкой навсегда?',
    ...
    successFooter: 'Приглашаю вас на ужин/n Время: В 17:30 заеду за вами/n Место встречи: Ресторан Sorrento/n Дресс-код: Вы в любом виде неотразимы для меня/n С вас требуется: Прекрасное настроение',
